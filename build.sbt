...
homepage := Some(url("https://github.com/pvorb/scala-potrace"))
...
pomExtra := (
  <scm>
    <url>git@github.com:pvorb/scala-potrace.git</url>
    <connection>scm:git:git@github.com:pvorb/scala-potrace.git</connection>
  </scm>
  <developers>
    <developer>
      <id>pvorb</id>
